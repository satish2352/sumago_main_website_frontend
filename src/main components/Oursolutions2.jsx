                                            ...
                                            {data.map((service) => (
                                                ...
                                                >
                                                    <li className={`menu-item menu-item-type-post_type menu-item-object-service`}>
                                                        <Link to={`/solutions/${encodeURIComponent(service.path)}`} style={{ textDecoration: 'none' }}>{service.title}</Link>
